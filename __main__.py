...
class Welcome:
    ...
    def __init__(self,window):
        ...
        global bg
        bg = ImageTk.PhotoImage(Image.open(resource_path('Stok_Image\Welcome to ALAMBOCA CINEMA.png')))
    ...
    def sign_in(self):
        ...
        global img_bck
        img_bck = ImageTk.PhotoImage(Image.open(resource_path('Stok_Image/back_icon.png')).resize(size=(40, 40)))
    ...
    def login(self):
        dt_akun = open(resource_path('Data/logindatabase.txt'), 'r').read().split('\n\n')
        un = self.a.get()
    ...
    def sign_up(self):
        dt_akunr = open(resource_path('Data/logindatabase.txt'), 'r')
        dt_akun = open(resource_path('Data/logindatabase.txt'), 'a')
