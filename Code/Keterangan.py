...
class Keterangan:
    def __init__(self,window, film, main):
        ...
        self.photo = Image.open(resource_path('Stok_Image/tembok.jpg')).resize(size=(1100, 600))
    ...
    def Keterangan_Film(self):
        k_film = open(resource_path('Data/Ket_Film.txt'), 'r')
    ...
    def gambar_film(self):
        ...
        img_open = Image.open(resource_path(self.lg)).resize((270, 380))
        global gambar
