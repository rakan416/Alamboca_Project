...
class Homepage:
    ...
    def __init__(self, window, main):
        ...
        self.data_new = open(resource_path('Data/Ket_Film.txt'), 'r').read().split('\n\n')
    ...
    def btt_loop(self, fr, homdat):
        ...
        data = open(resource_path('Data/film.txt'), 'r')
        d_film = data.read().split('\n')

        def img_pro(file):
            img_open = Image.open(resource_path(file)).resize((300, 450))
            global gambar
